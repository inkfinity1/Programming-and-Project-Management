...
def load_assets():
    try:
        ...
        background_level_four = pygame.image.load("graphics/level_four_background.png").convert_alpha()
...
def load_block_assets():
    try:
        ...
        lava_block_img = pygame.image.load('graphics/lava_block.png').convert_alpha()
