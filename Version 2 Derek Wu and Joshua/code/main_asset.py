...
def load_assets():
    try:
        ...
        joushua_page = pygame.image.load("graphics/joshua.png").convert_alpha()
        joushua_page= pygame.transform.scale(joushua_page, (WIDTH, HEIGHT))
        ...
        exit_button, instruction_page, objective_page,joushua_page)
    except pygame.error:
