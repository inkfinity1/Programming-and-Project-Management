...
def load_assets():
    try:
        ...
        background_level_one = pygame.image.load("graphics/level_one_background.png").convert_alpha()
        background_level_one = pygame.transform.scale( background_level_one, (WIDTH, HEIGHT))

        return background_img, information_button_img, info_image, game_one, background_level_one, 
    except pygame.error:
