...
(background_img, information_button_img, info_img, game_button, background_level_one,
 background_level_two, background_level_three, instruction_button, home_button, exit_button, instruction_page  ) = load_assets()
...
backgrounds = [background_level_one, background_level_two, background_level_three,background_level_three ]
    ...
    for event in pygame.event.get():
        ...
        # Main menu interactions
            ...
            if information_button_rect.collidepoint(event.pos):
                ...
                screen.blit(instruction_page , (0, 0)) # instruction_page 
                pygame.display.update()
            ...
            elif game_button_rect.collidepoint(event.pos): # Game page and exit the game
                if click_sound:
                    click_sound.play()
